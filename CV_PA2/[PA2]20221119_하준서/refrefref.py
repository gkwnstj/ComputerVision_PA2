...
cloud = PyntCloud(pd.DataFrame(
    ...
    data=np.concatenate((point3d[0].reshape(len(point3d[0]),1),point3d[1].reshape(len(point3d[0]),1),point3d[2].reshape(len(point3d[0]),1)), axis = 1),
    columns=["x", "y", "z"]))

cloud.to_file("output00.ply")
